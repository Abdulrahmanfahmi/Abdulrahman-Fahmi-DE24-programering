...
def main():
    print('Programmet startar...')  # Diagnostisk utskrift
    while True:
        print("\nMeny:")
...
def get_weather_data():
    print("Hämtar väderdata...")  # Diagnostisk utskrift
...
def process_and_save_to_excel(data):
    ...
    if forecasts:  # Kontrollera om det finns prognoser att spara
